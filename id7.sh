...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/aabell3/ngaco/master/null/sources.list.debian7"
...
# install openvpn
#wget -O /etc/openvpn/openvpn.tar "https://github.com/aabell3/FNF/raw/master/sett/openvpn-debian.tar"
#cd /etc/openvpn/
#tar xf openvpn.tar
#wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/aabell3/ngaco/master/null/1194.conf"
#service openvpn restart
#sysctl -w net.ipv4.ip_forward=1
#sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
#wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/aabell3/ngaco/master/null/iptables.up.rules"
...
#cd /etc/openvpn/
#wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/aabell3/ngaco/master/null/1194-client.conf"
...
curl "https://raw.githubusercontent.com/aabell3/ngaco/master/null/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://github.com/aabell3/FNF/raw/master/go/dropbear-2014.63.tar.bz2
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/aabell3/ngaco/master/null/squid3.conf"
...
# install pptp vpn
#wget https://raw.githubusercontent.com/aabell3/ngaco/master/null/pptpinstall.sh
...
wget -O user-expired.sh "https://raw.githubusercontent.com/aabell3/ngaco/master/freak/user-expired.sh"
wget -O userlimit.sh "https://raw.githubusercontent.com/aabell3/ngaco/master/null/limit.sh"
wget -O user-list.sh "https://raw.githubusercontent.com/aabell3/ngaco/master/freak/user-list.sh"
